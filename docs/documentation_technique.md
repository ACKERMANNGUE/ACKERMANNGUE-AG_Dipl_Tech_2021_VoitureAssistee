...
Il y avait 2 possibilité :

1. La première était de récupérer les câbles séries (rouge, bleu, jaune, ...) et de les connectés directement au GPIO sur les pins qui fournissent :
   - TX
   - RX
   - VCC
   - Ground
